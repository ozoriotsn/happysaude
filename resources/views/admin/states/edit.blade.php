...
@section('content')
    <div>
        ...
        <div class="row">
            <div class="col">
                <h1 class="mt-4">Editar estado</h1>
            ...
            <form method="POST"  action="{{ route('admin.state.update', $state->id) }}">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="text" name="name" id="name"
                        class="form-control @error('name') is-invalid @enderror" value="{{ old('name')?old('name'):$state->name }}">
                    @error('name')
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="text" name="uf" id="uf"
                        class="form-control @error('uf') is-invalid @enderror" value="{{ old('uf')?old('uf'):$state->uf }}">
                    @error('phone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
